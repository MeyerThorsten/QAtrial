...
export const templateSet: CountryTemplateSet = {
  ...
  requirements: [
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'us:regulatory-compliance:req-01',
    ...
    {
      templateId: 'us:regulatory-compliance:req-02',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'us:privacy-security:req-01',
    ...
    {
      templateId: 'us:privacy-security:req-02',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'us:accessibility:req-01',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'us:business-continuity:req-01',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'us:authentication:req-01',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'us:data-governance:req-01',
  ...
  tests: [
    {
      templateId: 'us:compliance:tst-01',
    ...
    {
      templateId: 'us:accessibility:tst-01',
    ...
    {
      templateId: 'us:compliance:tst-02',
    ...
    {
      templateId: 'us:business-continuity:tst-01',

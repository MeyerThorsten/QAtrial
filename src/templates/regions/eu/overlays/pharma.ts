...
export const templateSet: VerticalTemplateSet = {
  ...
  requirements: [
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'eu-pharma:computer-systems:req-01',
    ...
    {
      templateId: 'eu-pharma:data-integrity:req-01',
    ...
    {
      templateId: 'eu-pharma:electronic-signatures:req-01',
    ...
    {
      templateId: 'eu-pharma:data-integrity:req-02',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'eu-pharma:regulatory-affairs:req-01',
    ...
    {
      templateId: 'eu-pharma:pharmacovigilance:req-01',
    ...
    {
      templateId: 'eu-pharma:clinical-systems:req-01',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'eu-pharma:supply-chain-security:req-01',
  ...
  tests: [
    {
      templateId: 'eu-pharma:computer-systems:tst-01',
    ...
    {
      templateId: 'eu-pharma:data-integrity:tst-01',
    ...
    {
      templateId: 'eu-pharma:data-integrity:tst-02',
    ...
    {
      templateId: 'eu-pharma:supply-chain-security:tst-01',
    ...
    {
      templateId: 'eu-pharma:pharmacovigilance:tst-01',

...
export const templateSet: CountryTemplateSet = {
  ...
  requirements: [
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'gb:product-compliance:req-01',
    ...
    {
      templateId: 'gb:data-protection:req-01',
    ...
    {
      templateId: 'gb:data-protection:req-02',
    ...
    {
      templateId: 'gb:cybersecurity:req-01',
    ...
    {
      templateId: 'gb:data-protection:req-03',
    ...
    {
      templateId: 'gb:financial-regulation:req-01',
    ...
    {
      templateId: 'gb:accessibility:req-01',
    ...
    {
      templateId: 'gb:cybersecurity:req-02',
    ...
    {
      templateId: 'gb:cloud-security:req-01',
  ...
  tests: [
    {
      templateId: 'gb:product-compliance:tst-01',
    ...
    {
      templateId: 'gb:data-protection:tst-01',
    ...
    {
      templateId: 'gb:data-protection:tst-02',
    ...
    {
      templateId: 'gb:cybersecurity:tst-01',
    ...
    {
      templateId: 'gb:data-protection:tst-03',
    ...
    {
      templateId: 'gb:accessibility:tst-01',

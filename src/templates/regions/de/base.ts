...
export const templateSet: CountryTemplateSet = {
  ...
  requirements: [
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'de:information-security:req-01',
    ...
    {
      templateId: 'de:business-continuity:req-01',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'de:data-protection:req-01',
    ...
    {
      templateId: 'de:data-protection:req-02',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'de:accessibility:req-01',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'de:cybersecurity:req-01',
    ...
    {
      templateId: 'de:cybersecurity:req-02',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'de:compliance:req-01',
    ...
    // -----------------------------------------------------------------------
    {
      templateId: 'de:data-governance:req-01',
  ...
  tests: [
    {
      templateId: 'de:information-security:tst-01',
    ...
    {
      templateId: 'de:data-protection:tst-01',
    ...
    {
      templateId: 'de:accessibility:tst-01',
    ...
    {
      templateId: 'de:cybersecurity:tst-01',
    ...
    {
      templateId: 'de:cloud-security:tst-01',
    ...
    {
      templateId: 'de:compliance:tst-01',

...
export const templateSet: VerticalTemplateSet = {
  ...
  requirements: [
    ...
    {
      templateId: 'cro:protocol-management:req-01',
    ...
    {
      templateId: 'cro:data-management:req-01',
    ...
    {
      templateId: 'cro:document-management:req-01',
    ...
    {
      templateId: 'cro:monitoring:req-01',
    ...
    {
      templateId: 'cro:imp-management:req-01',
    ...
    {
      templateId: 'cro:data-integrity:req-01',
    ...
    {
      templateId: 'cro:data-management:req-02',
    ...
    {
      templateId: 'cro:biostatistics:req-01',
    ...
    {
      templateId: 'cro:regulatory:req-01',
    ...
    {
      templateId: 'cro:reporting:req-01',
    ...
    {
      templateId: 'cro:laboratory:req-01',
  ...
  tests: [
    ...
    {
      templateId: 'cro:data-management:tst-01',
    ...
    {
      templateId: 'cro:document-management:tst-01',
    ...
    {
      templateId: 'cro:monitoring:tst-01',
    ...
    {
      templateId: 'cro:imp-management:tst-01',
    ...
    {
      templateId: 'cro:data-integrity:tst-01',
    ...
    {
      templateId: 'cro:biostatistics:tst-01',
    ...
    {
      templateId: 'cro:reporting:tst-01',
